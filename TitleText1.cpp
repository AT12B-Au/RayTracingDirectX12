...
void TitleText1::Init(UINT version)
{
	if (version == 0)	//DirectX11
	{
		m_Model11 = new Model11;
		m_Model11->Load("Asset\\model\\Title1.fbx");
		...
		m_Position11 = D3DXVECTOR3(-5.0f, 1.0f, 2.0f);
	...
	else if (version == 1)	//DirectX12
	{
		...
		m_Model12->Load("Asset\\model\\Title1.fbx", NULL, DESCHEAP_NUM);
		...
		m_Position12 = XMFLOAT3(-5.0f, 1.0f, 2.0f);
		m_Rotation12 = XMFLOAT3(-0.1f, 0.1f, 0.0f);
		m_Scale12 = XMFLOAT3(1.0f, 1.0f, 1.0f);
	}
}

void TitleText1::UnInit(UINT version)
{
	if (version == 0)	//DirectX11
	{
		m_Model11->UnLoad();
...
void TitleText1::Update(UINT version)
{
	if (version == 0)	//DirectX11
	{
...
void TitleText1::Draw(UINT version)
{
	if (version == 0)	//DirectX11
	{

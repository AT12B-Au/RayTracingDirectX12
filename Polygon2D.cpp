...
//
//void Polygon2D::Init(UINT version)
//{
...
//
//		m_Vertex11[1].Position = D3DXVECTOR3(500.0f, 0.0f, 0.0f);
...
//
//		m_Vertex11[2].Position = D3DXVECTOR3(0.0f, 500.0f, 0.0f);
...
//
//		m_Vertex11[3].Position = D3DXVECTOR3(500.0f, 500.0f, 0.0f);
...
//
//		m_Model2D11->Init(m_Vertex11,"Asset\\texture\\1.dds", "shader\\PhongVS.cso", "shader\\PhongPS.cso");
//	}
...
//
//		m_Vertex12[1].Position = XMFLOAT3(SCREEN_WIDTH, 0.0f, 0.0f);
...
//
//		m_Vertex12[2].Position = XMFLOAT3(0.0f, SCREEN_HEIGHT, 0.0f);
...
//		
//
//		m_Model2D12->Init(m_Vertex12,L"Asset\\texture\\Title.png", DXGI_FORMAT_B8G8R8A8_UNORM,
//			4096, 4096,m_VertexShader12.Get(),m_PixelShader12.Get());
//	}
//
//}
//
//void Polygon2D::UnInit(UINT version)
//{
//	if (version == 0)	//DirectX11
//	{
//		m_Model2D11->UnInit();
...
//}
//
//void Polygon2D::Update(UINT version)
//{
//
//	if (version == 0)
//	{
...
//}
//
//void Polygon2D::Draw(UINT version)
//{
//	if (version == 0)	//DirectX11
//	{
//		m_Model2D11->Draw();
